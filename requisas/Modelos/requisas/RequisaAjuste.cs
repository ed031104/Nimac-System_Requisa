...
namespace Modelos.requisas
{
    ...
    {
        private string _idRequisaAjuste;
        ...
        public RequisaAjuste(string idRequisaAjuste, Requisa requisa, TipoAjuste tipoAjuste, string creadoPor, string modificadoPor, DateTime fechaRegistro, DateTime fechaModificacion, decimal? montoAjuste, string descripcion, ParteSucursal parteSucursal, decimal costoPromedio, decimal costoPromedioExtendido, Reclamo? reclamo, Transferencia? transferencia)
        {
        ...
        public string IdRequisaAjuste { get => _idRequisaAjuste; set => _idRequisaAjuste = value; }
        ...
        public Transferencia? Transferencia { get => _transferencia; set => _transferencia = value; }
        ...
        public class Builder
        {
            ...
            public Builder SetIdRequisaAjuste(string id)
            {
            ...
            public Builder SetReclamo(Reclamo? reclamo)
            {
                _requisaAjuste._reclamo = reclamo;
                return this;
            }
            public Builder SetTransferencia(Transferencia? transferencia)
            {
                _requisaAjuste._transferencia = transferencia;
                return this;
            }
